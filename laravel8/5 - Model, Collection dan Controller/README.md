...
![Artisan Command Pallete Create Model](assets/artisan-command-palette-create-model.png)
...
![Collection Available Method](assets/collection-available-method.png)
