...
- [View Posts](#view-posts)
  - [Hero Posts](#hero-posts)
  - [Card Posts](#card-posts)
- [View Single Post](#view-single-post)
...
![Design Posts](assets/design-posts.png)
...
![Hero Post Preview](assets/hero-post-preview.png)
...
![Hero Post Unsplash](assets/hero-post-image-usnplash.png)
...
| ------------------------------------------------ | ---------------------------------------------- |
| ![Before Skip Post](assets/before-skip-post.png) | ![After Skip Post](assets/after-skip-post.png) |
...
![Card Post Image Unsplash](assets/card-post-image-unsplash.png)
...
![Single Post Preview](assets/single-post-preview.png)
...
![Single Post Paragraphs](assets/single-post-paragraphs.png)
...
![Single Post Final](assets/single-post-final.png)
...
![Categories Final](assets/categories-final.png)
